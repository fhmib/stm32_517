...
int cmd_cal_init(int argc, char **argv)
{
  ...
  i2c_eeprom_write_buffer(EEPROM_ADDR, AM1_PIN_EEPROM_ADDR, buf, count);
  ...
  i2c_eeprom_write_buffer(EEPROM_ADDR, VOA1_TM1_EEPROM_ADDR, buf, count);
  ...
  i2c_eeprom_write_buffer(EEPROM_ADDR, VOA2_TM2_EEPROM_ADDR, buf, count);
